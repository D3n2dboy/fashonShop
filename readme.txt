...
При работе с Git, разработчики иногда сталкиваются с ошибкой «remote origin already exists». Эта ошибка возникает, когда в репозитории уже существует удаленный репозиторий с именем «origin». Чаще всего это происходит, когда разработчик клонирует репозиторий с уже установленными настройками удаленного репозитория.

Чтобы исправить эту ошибку, необходимо удалить текущую настройку удаленного репозитория с именем «origin» и установить новую настройку. Для этого можно использовать команду «git remote remove origin», чтобы удалить текущий удаленный репозиторий, а затем команду «git remote add origin «, чтобы добавить новый удаленный репозиторий.
Источник: https://uchet-jkh.ru/i/osibka-remote-origin-already-exists-cto-delat
